...
let handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            if (!response.ok) throw `*Error*\nNo se pudo obtener la aplicación con el ID: ${text} en ninguna API.\n*NOTA:* Utilice el nombre del paquete para descargarlo, _si no conoce el nombre del paquete de la App use /pck y el nombre de la App_\n🥀*Ejemplo de busqueda:*/pck whatsapp\n🧩*Ejemplo de descarga* .apk com.whatsapp`;
        }
