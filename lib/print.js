...
║ ${chalk.greenBright('%s')} ${chalk.black(chalk.cyan('%s'))}ㅤ${chalk.black(chalk.cyan('%s'))} ${chalk.magenta('%s [%s %sB]')}
║ ${chalk.white('%s')} ${chalk.yellow('%s%s')} ${chalk.blueBright('%s')} ${chalk.black(chalk.red('%s'))}
 ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ ☜(ˆ▽ˆ)`.trim()),
