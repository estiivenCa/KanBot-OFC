...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(chalk.yellowBright(`▰▰▰▰▰▰▰▰▰▰▰▰  ${vs}  ▰▰▰▰▰▰▰▰▰▰▰▰ (っ◔◡◔)っ ♥
║ ${chalk.greenBright('%s')} ${chalk.magentaBright(chalk.cyanBright('%s'))}ㅤ${chalk.greenBright(chalk.cyanBright('%s'))} ${chalk.magenta('%s [%s %sB]')}
║ ${chalk.whiteBright('%s')} ${chalk.blackBright('%s%s')} ${chalk.blueBright('%s')} ${chalk.greenBright(chalk.red('%s'))}
 ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ ☜(ˆ▽ˆ)`.trim()),
